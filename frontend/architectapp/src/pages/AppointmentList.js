...
const AppointmentList = ({ selectedArchitectId }) => {
            ...
            {filteredAppointments.map((appointment) => (
              <tr key={appointment._id}>
                ...
                <td style={styles.tableCell}>
                         <button className="btn btn-success" onClick={() => handleResponse(appointment._id, 'Approved')}>
                      Approve
                    </button>
                    <button className="btn btn-secondary" onClick={() => handleResponse(appointment._id, 'Rejected')}>
                      Reject
                    </button>
                  {/* <button 
