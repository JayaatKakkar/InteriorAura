      ...
      <div className="sidebar-wrapper scrollbar scrollbar-inner">
        <div className="sidebar-content">
          <ul className="nav nav-secondary">
            ...
            <li className="nav-item">
              <Link to="/blueprint">
                <i className="fas fa-ruler" style={{ color: "#B78D65" }}></i>
                <p>Blueprint</p>
              </Link>
            </li>
            ...
            <li className="nav-item">
              <Link to="/material">
                <i className="fas fa-truck" style={{ color: "#B78D65" }}></i>
                <p>Material</p>
              </Link>
            </li>
            ...
            <li className="nav-item">
              <Link to="/Packages">
                <i className="fas fa-briefcase" style={{ color: "#B78D65" }}></i>
                <p>Packages</p>
              </Link>
            </li>

            <li className="nav-item">
              <Link to="/architectlist">
                <i className="fas fa-envelope-open" style={{ color: "#B78D65" }}></i>
                <p>Architect Login</p>
              </Link>
            </li>
