...
const Admin_Login = ({ setIsAuthenticated }) => {
        ...
        {`
          * {
          ...
          body {
            ...
            background: url('https://thumbs.dreamstime.com/b/brown-wave-stream-abstract-background-vector-pattern-eps-163408194.jpg') no-repeat center center;
